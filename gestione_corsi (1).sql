...
--
-- Host: 127.0.0.1
-- Creato il: Dic 09, 2025 alle 13:57
...
(3, 'Certificazione Web', '2023-06-10', 80.00);
...
(12, 1, 1, '2023-04-01', '2023-04-30', 8.50),
(13, 1, 2, '2023-05-01', '2023-06-15', 7.00),
(14, 2, 1, '2023-04-01', '2023-04-30', 9.00),
(15, 2, 3, '2023-06-01', '2023-06-30', 8.00),
(16, 3, 2, '2023-05-01', '2023-06-15', 6.50);
...
(1, 'Giovanni', 'Neri', '2020-01-15', 2500.00),
...
ALTER TABLE `corsi_frequentati`
  ADD PRIMARY KEY (`id`),
  ADD KEY `corsista_id` (`corsista_id`) USING BTREE,
  ADD KEY `corso_id` (`corso_id`) USING BTREE;
